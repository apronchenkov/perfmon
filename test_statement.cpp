...
BOOST_AUTO_TEST_CASE(test_statement_calls)
{
    ...
    BOOST_REQUIRE (counters["statement_calls_A"].Ticks() > counters["statement_calls_B"].Ticks());
    BOOST_REQUIRE (counters["statement_calls_B"].Ticks() > counters["statement_calls_C"].Ticks());
